...
public class DialogTestimonio extends DialogFragment implements OnShowListener, EvtCloseDialog, OnKeyListener, OnClickListener, EvtEndFavorito, AnimationListener{
	...
	public View onCreateView(LayoutInflater inflater,
		...
		return inflater.inflate(R.layout.dialog_testimonio, container, false);
	}
	...
	private void setExtra(Extra extra) {
		card=extra.card;
		tes=(ClsTestimonio) extra.objectSelected;
	}
	
	private ScrollFace scroll;
	private void initViews(View view) {
		container=(ViewGroup) view.findViewById(R.id.dialTes_container);
		contenido=(ViewGroup) view.findViewById(R.id.dialTes_lin);
		scroll =(ScrollFace) view.findViewById(R.id.dialTes_scrollFace);
		scroll.setContainers(container, contenido);
		scroll.setEvtCloseDialog(this);
		scroll.setEnabled(false);
		scroll.smoothScrollTo(0, 0);
		txtTitulo = (TextView) view.findViewById(R.id.dialTes_titulo);
        txtDescripcion = (TextView) view.findViewById(R.id.dialTes_descripcion);
		((ImageView)view.findViewById(R.id.dialTes_btnCompartir)).setOnClickListener(this);
		img=(ImageView)view.findViewById(R.id.dialTes_img);
        btnFavorito=((ImageView)view.findViewById(R.id.dialTes_btnFavorito));
        btnFavorito.setOnClickListener(this);
        btnFavorito.setEnabled(true);
        txtFavorito = (TextView) view.findViewById(R.id.dialTes_txtFavorito);
		
        Picasso.with(getActivity())
		.load(GeneralData.SERVER_IMAGES+tes.getReg_id()+"_"+tes.getTes_id()+".jpg")
		.into(img);
...
//    	);
        if(getResources().getBoolean(R.bool.isTablet)){
            ...
            ViewGroup margin=(ViewGroup) view.findViewById(R.id.dialTes_margin);
        ...
        img.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				i.putExtra("url", GeneralData.SERVER_IMAGES+tes.getReg_id()+"_"+tes.getTes_id()+".jpg");
				startActivity(i);
			}
		});
	}
	...
	private void setInfo() {
		txtTitulo.setText(tes.getTes_titulo());
		txtDescripcion.setText(tes.getTes_descripcion());
	}
	...
	private void share() {
		...
		shareContend.setClass(tes, GeneralData.TESTIMONIO);
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.dialTes_btnCompartir:
			share();
			break;

		case R.id.dialTes_btnFavorito:
	...
	public static DialogTestimonio newInstace(EvtCancelDialog ecd, Extra extra) {
		DialogTestimonio dial=new DialogTestimonio();
		dial.setEvtCancelDialog(ecd);
		dial.setExtra(extra);
		return dial;
	}
	
	public static void restoreInstace(DialogTestimonio dialAdoptar, EvtCancelDialog ecd, Extra extra) {
	...
	public void OnEndFavorito(Boolean does, Object tag) {
		...
		if(does){
			try {
				...
				fav.init(tes.getTes_id(), GeneralData.TESTIMONIO);
